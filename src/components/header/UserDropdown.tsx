...
export default function UserDropdown() {
  ...
  function closeDropdown() {
   ...
   // 2. CREAR ESTA FUNCIÓN: Gatilla la destrucción de la cookie en FastAPI
  const handleLogout = async () => {
    closeDropdown(); // Cierra visualmente la ventanilla flotante
    await logout();  // Ejecuta la limpieza de red y borrado de estados de React
  };
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <button
          onClick={handleLogout} // 👈 Cambiamos el link por un evento de clic seguro
