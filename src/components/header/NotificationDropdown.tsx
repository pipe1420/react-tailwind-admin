...
export default function NotificationDropdown() {
  ...
  const getEmoji = (accessType: "vehicular" | "peatonal") => {
    return accessType === "vehicular" ? "🚗" : "🚶";
  };
    ...
    <div className="relative">
      ...
      >
        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
          {loading && <li className="p-4 text-center text-gray-500">Cargando...</li>}
          ...
          {!loading &&
            notifications.map((notification) => (
              <li key={notification.id}>
                ...
                >
                  <div className="flex items-center justify-center w-10 h-10 text-2xl bg-gray-200 rounded-full dark:bg-gray-700">
                    {getEmoji(notification.access_type)}
                  </div>
                  ...
                  <span className="block">
                    <span className="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400 space-x-1">
                      ...
                      <span>
                        ha abierto el acceso {notification.access_type}.
                      </span>
                    </span>
